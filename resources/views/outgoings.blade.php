        ...
        <div class="col-sm-12 col-md-12">
            <div class="col-md-3">
                <div class="card bg-c-blue order-card">
                    <div class="card-body">
                        <h6 class="m-b-20">Outgoings</h6>
                        <h2 class="text-left"><span id="totalAmount">{{ $outgoings->count() }}</span></h2>
                    </div>
                </div>
            </div>
            <div> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#AddoutgoingModal">Add
                    Outgoing</button>

                <div id="AddoutgoingModal" class="modal fade" tabindex="-1" role="dialog"
                    aria-labelledby="AddoutgoingModalTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="AddoutgoingModalTitle">Add outgoing</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                        aria-hidden="true">&times;</span></button>
                            </div>
                            <div class="modal-body">
                                <form method="POST" action="{{ route('create_outgoing') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="mb-3 form-control" name="type">
                                            <option value="USSD">SENDERID</option>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="dt-responsive table-responsive">
                        <table id="outgoings-table" class="table  table-striped table-bordered nowrap">
                            <thead>
                                <tr>
                                    <th>CSP</th>
                                    <th>SHORTCODE</th>
                            ...
                            <tbody>
                                @foreach ($outgoings as $outgoing)
                                    <tr>
                                        ...
                                        <th>{{ $outgoing->csp }}</th>
                                        <th>{{ $outgoing->shortcode }}</th>
                                        <th>{{ $outgoing->created_at }}</th>
                                    </tr>
                                @endforeach
                            <tfoot>
                                <th>Username</th>
...
@section('page-js')
    ...
    <script>
        $(document).ready(function() {
            var t = $('#outgoings-table').DataTable({
                order: [
                    [0, 'desc']
                ],
            });
